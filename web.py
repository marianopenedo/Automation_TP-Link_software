...
def web(login, passw, res, ssid, senhaW, model, cwd):
    ...
    #     driver.find_element(By.ID, "txt-wireless-name-ssid-2g").send_keys("administrador")
    #     time.sleep(3)
    #     driver.find_element(By.ID, "txt-wireless-password-2g").clear()
    #     driver.find_element(By.ID, "txt-wireless-password-2g").send_keys("administradooooooooor")
    #     time.sleep(3)
